<?php 
	...
	$consulta = "SELECT email, nome FROM usuarios WHERE id = '$id'";
    ...
    while($dado = $result->fetch_array()){
		...
		$mail->Subject = "Aviso: Novo Grupo de Pesquisa"; # Assunto da mensagem
		$mail->Body = 'Você é o Líder de um novo grupo de pesquisa que foi cadastrado, entre agora no sistema para ativá-lo!';
