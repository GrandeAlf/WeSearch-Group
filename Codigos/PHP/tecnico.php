    ...
    <div class="wrapper" >
      <form class="form-signin" method="post" action="validalogin.php"> 
         <div class="text-center">
          <h2 class="form-signin-heading">Técnico</h2>
...
<div class="text-center">
          <?php 
            ...
            $consulta = "SELECT `cod_tecnico`, `nome`, `lattes`, `atividade_realizada`, `fk_graduacao`, `curso`, `ano_conclusao`, `data_inicio`, `data_fim` FROM `tecnicos` WHERE `cod_tecnico` = '$id'";
