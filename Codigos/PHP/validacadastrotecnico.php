<?php 
	...
	$consulta = "INSERT INTO tecnicos( nome, lattes, atividade_realizada, fk_graduacao, curso, ano_conclusao, fk_cod_grupo, fk_especialidade, data_inicio, situacao) 	VALUES ('$nome', '$lattes', '$atividade', '$graduacao', '$curso','$ano', '$grupo', '$linha', '$inclusao', '1')";
